"""MojoGP multi-output scaling benchmark wrapper."""
...
def run_mojogp_multi_output_scaling_module(
    *,
    ...
    return run_benchmark_module(
        ...
        description=(
            f"Runs MojoGP multi-output scaling case prediction={payload['prediction_mode']} "
