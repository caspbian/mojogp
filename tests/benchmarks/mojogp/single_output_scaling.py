"""MojoGP single-output scaling benchmark wrapper."""
...
def run_mojogp_single_output_scaling_module(
    *,
    ...
    return run_benchmark_module(
        ...
        description=(
            f"Runs MojoGP single-output scaling case prediction={payload['prediction_mode']} "
